...
void MidiController::LoadLayout(const ofxJSONElement& moduleInfo)
{
   ...
   channelMap[" 1"] = (int)ChannelFilter::k1;
   channelMap[" 2"] = (int)ChannelFilter::k2;
   channelMap[" 3"] = (int)ChannelFilter::k3;
   channelMap[" 4"] = (int)ChannelFilter::k4;
   channelMap[" 5"] = (int)ChannelFilter::k5;
   channelMap[" 6"] = (int)ChannelFilter::k6;
   channelMap[" 7"] = (int)ChannelFilter::k7;
   channelMap[" 8"] = (int)ChannelFilter::k8;
   channelMap[" 9"] = (int)ChannelFilter::k9;
